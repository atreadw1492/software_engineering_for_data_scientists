...
class TestModelOutputs(unittest.TestCase):
    ...
    def test_missing_config_keys(self):
        ...
        try:
            pipeline.run_config_checks(TestModelOutputs.missing_key_config)
    ...
    def test_fake_input_file(self):
        try:
            pipeline.\
            run_config_checks(TestModelOutputs.config_with_fake_input_file)
        except KeyError:
            return True
    ...
    def test_fake_model_file(self):
        try:
            pipeline.\
            run_config_checks(TestModelOutputs.config_with_fake_model_file)
        except KeyError:
            return True
